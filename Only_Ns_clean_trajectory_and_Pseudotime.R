################################################################
#### 3. Pipeline of analisis of NCPs population             #####
###############################################################
### Set colors
...
####################################################
######## Re-intetration of NCPs population     ######
###### 
source("/media/simple/Volume2_4T/RNA_SEQ_our/SingleCells/SingleCells_functions/SingleCellsUtils.R")
Ns = readRDS(file = "/media/simple/Volume2_4T/RNA_SEQ_our/SingleCells/Rhapsody/precursors/IntegrationSamples/Paper_RDS_files/BMs.integrated.Ns.clean_50PC_Mt_CC.rds")
...
N0_c = DimPlot(Ns, reduction="umap_learn50PC",cells.highlight=WhichCells(Ns,idents="NCP1"))
N1_c = DimPlot(Ns, reduction="umap_learn50PC",cells.highlight=WhichCells(Ns,idents="NCP2"))
N2_c = DimPlot(Ns, reduction="umap_learn50PC",cells.highlight=WhichCells(Ns,idents="NCP3"))
N3_c = DimPlot(Ns, reduction="umap_learn50PC",cells.highlight=WhichCells(Ns,idents="NCP4"))
...
my_levels <- c("NCP1","NCP2","NCP3","NCP4");length(my_levels) ### 0.4
