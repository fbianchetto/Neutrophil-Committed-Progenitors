...
##### donor1
setwd("/media/pg/Volume_300G/home/pg/GEO/fbianchetto/SingleCells_BD/Processed_files")
donor1_NP1  <- read.table("donor1_SampleTag03_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor1_NP2  <- read.table("donor1_SampleTag04_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor1_NP3  <- read.table("donor1_SampleTag05_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor1_NP4  <- read.table("donor1_SampleTag06_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
...
donor1_NP1$Cells = "NP1"
donor1_NP2$Cells = "NP2"
donor1_NP3$Cells = "NP3"
donor1_NP4$Cells = "NP4"
donor1_cMOP$Cells = "cMOP"
donor1 <- rbind(donor1_NP1,donor1_NP2,donor1_NP3,donor1_NP4,donor1_cMOP)
...
saveRDS(donor1_seurat, file = "/media/pg/Volume2_4T/RNA_SEQ_our/SingleCells/Rhapsody/precursors/IntegrationSamples/RDS_files/donor1_seurat.rds")

#### donor2
donor2_NP1  <- read.table("donor2_SampleTag08_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor2_NP2  <- read.table("donor2_SampleTag09_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor2_NP3  <- read.table("donor2_SampleTag10_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor2_NP4  <- read.table("donor2_SampleTag11_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
...
donor2_NP1$Cells = "NP1"
donor2_NP2$Cells = "NP2"
donor2_NP3$Cells = "NP3"
donor2_NP4$Cells = "NP4"
donor2_cMOP$Cells = "cMOP"
donor2 <- rbind(donor2_NP1,donor2_NP2,donor2_NP3,donor2_NP4,donor2_cMOP)
...
saveRDS(donor2_seurat, file = "/media/pg/Volume2_4T/RNA_SEQ_our/SingleCells/Rhapsody/precursors/IntegrationSamples/RDS_files/donor2_seurat.rds")

##### donor3
donor3_NP1  <- read.table("donor3_SampleTag01_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor3_NP2  <- read.table("donor3_SampleTag02_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor3_NP3  <- read.table("donor3_SampleTag03_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
donor3_NP4  <- read.table("donor3_SampleTag04_hs_RSEC_MolsPerCell_with_barcode.csv.gz", sep = ",", header = TRUE, row.names = 1,check.names=FALSE,comment.char = "#")
...
donor3_NP1$Cells = "NP1"
donor3_NP2$Cells = "NP2"
donor3_NP3$Cells = "NP3"
donor3_NP4$Cells = "NP4"
donor3_cMOP$Cells = "cMOP"
donor3 <- rbind(donor3_NP1,donor3_NP2,donor3_NP3,donor3_NP4,donor3_cMOP)
...
saveRDS(donor3_seurat, file = "/media/pg/Volume2_4T/RNA_SEQ_our/SingleCells/Rhapsody/precursors/IntegrationSamples/RDS_files/donor3_seurat.rds")
...
#########
BM.integrated = merge(x=donor1_seurat,y=c(donor2_seurat,donor2_seurat))
...
saveRDS(BM.integrated, file = "/home/pg/RNA_SEQ_our/SingleCells/Rhapsody/precursors/IntegrationSamples/RDS_files/precursors.integrated_BD_p1_p99_Mt_CC_genes.rds")